...
type ThingInternalTypes<T extends ThingType> = {
    ...
    [ThingType.roundblock]: [cachedPM: Thing | null, readonly Thing[]],
    [ThingType.squareblock]: [cachedPM: Thing | null, readonly Thing[]],
    [ThingType.curlyblock]: [cachedPM: Thing | null, readonly Thing[]],
    [ThingType.topblock]: [cachedPM: Thing | null, readonly Thing[]],
    [ThingType.stringblock]: [cachedPM: Thing | null, readonly Thing<ThingType.string | ThingType.roundblock>[]],
